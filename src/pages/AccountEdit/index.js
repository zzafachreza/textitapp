    ...
    return (
        <SafeAreaView style={{
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                ...
                <MyInput label="Full Name" iconname="person" value={kirim.nama_lengkap} onChangeText={x => setKirim({ ...kirim, nama_lengkap: x })} />
                <MyGap jarak={10} />
                ...
                <MyInput label="Phone Number" iconname="call" keyboardType="phone-pad" value={kirim.telepon} onChangeText={x => setKirim({ ...kirim, telepon: x })} />
                <MyGap jarak={10} />

                <MyInput label="Address" iconname="location" value={kirim.alamat} onChangeText={x => setKirim({ ...kirim, alamat: x })} />
                <MyGap jarak={10} />

                <MyPicker iconname="male-female" label="Gender" value={kirim.gender} onValueChange={x => {
                    setKirim({
                        ...kirim,
                        gender: x
                    })
